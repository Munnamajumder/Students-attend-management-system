      ...
      <h2>
       ...
       <div class="well text-center" style="font-size: 20px;">
         <strong>Date: </strong> <?php echo $cur_date;?>
             ...
             <select name="subject" ng-model='discussionsSelect' class='form-control' STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #72A4D2;">

                  <option value='total'>Select Your subject</option>
                  <option value='EEE111'>EEE111</option>
                  <option value='EEE112'>EEE112</option>
                  <option value='EEE113'>EEE113</option>
