      ...
      <h2>
            ...
            if (session::get('position') == 'teacher') { ?>
               <a class="btn btn-success" href="add.php">add member</a>
                ...
                <a class="btn btn-success" href="depstudent.php">Department</a>
 ...
 <?php
         ...
         ?> 
            ...
            <tr style="font-size: 16px">
               ...
               <td>
                  ...
                  <td>
               <input type="text" readonly name="department" value="<?php echo $value['department']; ?>">
               </td>
               <td>
               <input type="text" readonly name="semester" value="<?php echo $value['semester']; ?>">
               </td>
  ...
  <?php } ?>
         ...
         <?php } else{ ?>  
            ...
            <div class='alert alert-danger'><strong>Sorry! </strong>No Data Available. Please Add Students !</div>
